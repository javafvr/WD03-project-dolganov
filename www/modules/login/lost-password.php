	...
	if (empty($errors)) {
		...
		if (isset($user)) {
			function random_str($num=30){
				return substr(str_shuffle('abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'), 0, $num);
			}
			...
			$success[] =[
				...
				'desc' => "<p>Инструкции по восстановленю доступа высланы на {$_POST['email']}</p>"];
